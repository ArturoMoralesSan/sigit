...
{{-- Metadata --}}
@section('title', 'Agregar Equipo o Material')
@section('tab_title', 'Agregar Equipo o Material | ' . config('app.name'))
@section('description', 'Agregar Equipo o Material.')
    ...
    <section class="mb-16">
        ...
        <div class="fluid-container mb-16">
            <p class="mb-12">
                ...
                <a href="{{ url('admin/inventario/') }}">Ver todo el equipo/material</a>
            </p>
                    ...
                    <section class="db-panel">
                        ...
                        <div class="md:row">
                            <div class="md:col-1/2">
                                <div class="form-control">
                                    ...
                                    <text-field name="num_serie" v-model="fields.num_serie"></text-field>
                            ...
                            <div class="md:col-1/2">
                                <div class="form-control">
                                    ...
                                    <text-field name="control_tag" v-model="fields.control_tag"></text-field>
                        ...
                        <div class="md:row">
                            <div class="md:col-1/2">
                                <div class="form-control">
                                    ...
                                    <text-field name="product" v-model="fields.product"></text-field>
                            ...
                            <div class="md:col-1/2">
                                <div class="form-control">
                                    ...
                                    <text-field name="area" v-model="fields.area"></text-field>
                        ...
                        <div class="md:row">
                            <div class="md:col-1/2">
                                <div class="form-control">
                                    ...
                                    <text-field name="pu" v-model="fields.pu"></text-field>
                        ...
                        <div class="md:row">
                            <div class="md:col-1/2 justify-content-center">
                                ...
                                <div class="row">
                                    <div class="form-control" style="width: 100%;">
                                        <text-field class="form-control" type="number" min="0" name="quantity"
